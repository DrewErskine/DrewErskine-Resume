  ...
  return (
    <section className="section sectionContact">
      ...
      <form className="section-content" onSubmit={handleSubmit} noValidate>
        <div className="mb-4">
          <label htmlFor="name" className="block text-sm font-medium text-indigo-600">Name</label>
          <input
            type="text"
            name="name"
        ...
        <div className="mb-4">
          <label htmlFor="message" className="block text-sm font-medium text-indigo-600">Message</label>
          <textarea
            name="message"
